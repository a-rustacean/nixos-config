...
-- Springs
hl.curve("bouncy", { type = "spring", mass = 1, stiffness = 80, dampening = 18 })
hl.curve("snappy", { type = "spring", mass = 1, stiffness = 120, dampening = 14 })
...
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1.49, bezier = "easeOutExpo", style = "popin 87%" })
